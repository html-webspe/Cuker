(() => {
    ...
    function initSliders() {
        if (document.querySelector(".courses__slider")) new core(".courses__slider", {
            ...
            loop: true,
            speed: 800,
            slideClass: "courses__slider-slide",
            wrapperClass: "courses__slider-wrapper",
            breakpoints: {
                320: {
                    slidesPerView: 1
                },
            ...
            pagination: {
                el: ".navigation-courses__pagination",
                type: "fraction",
            ...
            navigation: {
                prevEl: ".navigation-courses__button-prev",
                nextEl: ".navigation-courses__button-next"
            }
        });
        if (document.querySelector(".blog__slider")) new core(".blog__slider", {
            modules: [ Navigation, Manipulation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            speed: 800,
            ...
            pagination: {
                el: ".navigation-blog__pagination",
                type: "fraction",
                renderFraction: function(currentClass, totalClass) {
                    return '<span class="' + currentClass + '"></span>' + " из " + '<span class="' + totalClass + '"></span>';
                }
            ...
            navigation: {
                prevEl: ".navigation-blog__button-prev",
                nextEl: ".navigation-blog__button-next"
            }
        });
        if (document.querySelector(".webinar-speaker__slider")) new core(".webinar-speaker__slider", {
            modules: [ Navigation, Manipulation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            speed: 800,
            slidesPerView: 1,
            slideClass: "webinar-speaker__slide",
            wrapperClass: "webinar-speaker__wrapper",
            pagination: {
                el: ".webinar-speaker__pagination",
                type: "fraction",
                renderFraction: function(currentClass, totalClass) {
                    return '<span class="' + currentClass + '"></span>' + " из " + '<span class="' + totalClass + '"></span>';
                }
            ...
            navigation: {
                prevEl: ".webinar-speaker__slider-button-prev",
                nextEl: ".webinar-speaker__slider-button-next"
            }
        });
        if (document.querySelector(".course-reviews__slider")) new core(".course-reviews__slider", {
            modules: [ Navigation, Manipulation, Pagination, Grid ],
            observer: true,
            observeParents: true,
            speed: 800,
            slideClass: "course-reviews__slide",
            wrapperClass: "course-reviews__wrapper",
            breakpoints: {
                320: {
                    slidesPerView: 1,
                    spaceBetween: 80,
            ...
            pagination: {
                el: ".navigation-reviews__pagination",
                type: "fraction",
                renderFraction: function(currentClass, totalClass) {
                    return '<span class="' + currentClass + '"></span>' + " из " + '<span class="' + totalClass + '"></span>';
                }
            ...
            navigation: {
                prevEl: ".navigation-reviews__button-prev",
                nextEl: ".navigation-reviews__button-next"
            }
        });
    }
    ...
    function headerScroll() {
        ...
        const header = document.querySelector("header.header-secondary");
        if (header) {
    ...
    if (checkboxInput) checkboxInput.forEach((element => {
        element.addEventListener("change", (function() {
            ...
            if (th.checked) {
                ...
                th.closest("form").querySelector(".wpcf7-list-item").classList.remove("_err");
            } else {
                th.closest("form").querySelector(".wpcf7-list-item").classList.add("_err");
                formButton.disabled = true;
            }
        }));
    }));
    const h = document.querySelector(".header"), reviewsIcon = document.querySelector(".course-advantage__label"), reviewsContent = document.querySelector(".course-advantage__body"), sectionPackage = document.getElementById("package");
    function myScroll() {
        if (reviewsIcon) if (window.scrollY + h.offsetHeight + 250 >= script_offset(reviewsContent).top) reviewsIcon.classList.add("animation"); else reviewsIcon.classList.remove("animation");
        if (sectionPackage) if (window.scrollY >= script_offset(sectionPackage).top && window.scrollY <= script_offset(sectionPackage).top + sectionPackage.offsetHeight) h.classList.add("hide"); else h.classList.remove("hide");
    }
    ...
    if (timers) timers.forEach((timer => {
        const daysVal = timer.querySelector(".time-count__days .time-count__val");
        ...
        const timeCount = () => {
            ...
            daysText.textContent = declOfNum(days, [ "dni", "dni", "dni" ]);
            hoursText.textContent = declOfNum(hours, [ "godziny", "godziny", "godziny" ]);
            minutesText.textContent = declOfNum(minutes, [ "minuty", "minuty", "minuty" ]);
            secondsText.textContent = declOfNum(seconds, [ "sekundy", "sekundy", "sekundy" ]);
        };
        timeCount();
